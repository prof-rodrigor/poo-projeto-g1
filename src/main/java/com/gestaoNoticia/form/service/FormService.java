...
import com.gestaoNoticia.form.model.validadores.validadoresCampo.ValidadorAutor;
...
public class FormService extends AbstractService {
    ...
    public void iniciarFormularios(){
        ...
        form.addCampo(new Campo("categoria", "Categoria","input", new ValidadorTexto(null,2, 30), true));
        form.addCampo(new Campo("autor", "Autor","input", new ValidadorAutor(new ValidadorTexto(null,2, 80)), true));
